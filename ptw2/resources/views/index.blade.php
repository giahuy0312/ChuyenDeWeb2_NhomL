                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="tm-product tm-scrollanim">
                            <div class="tm-product-topside">
                                ...
                                <ul class="tm-product-actions">
                                    <form action="{{ route('order.store') }}" method="POST"
                                        ...
                                        <li><button type="submit"><i class="ion-android-cart"></i> Add to cart</button>
                                        </li>
                                    </form>
                                    ...
                                    <form action="{{ route('wishlist.store') }}" method="POST"
                                        ...
                                        @csrf
                                        <input type="hidden" value="{{ $product->id }}" name="product" id="product">
                                        <li><button type="submit"><i class="ion-heart"></i></button></li>
                                    </form>
                            ...
                            <div class="tm-product-bottomside">
                                <h6 class="tm-product-title"><a href="product-details.html">{{ $product->name }}</a>
                                </h6>
                ...
                <div class="tm-product tm-scrollanim">
                    <div class="tm-product-topside">
                        ...
                        <ul class="tm-product-actions">
                            ...
                            <li><button data-fancybox data-src="#tm-product-quickview"><i class="ion-eye"></i></button>
                            </li>
                ...
                <div class="tm-blog tm-scrollanim">
                    <div class="tm-blog-topside">
                        <div class="tm-blog-thumb">
                            <img src="{{ asset('images/image-products') }}/{{ $product->image }}" alt="blog image">
                        </div>
