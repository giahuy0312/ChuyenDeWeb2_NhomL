                                    ...
                                    <div class="tm-prodetails-images">
                                        <div class="tm-prodetails-largeimages">
                                            <div class="tm-prodetails-largeimage">
                                                <a data-fancybox="tm-prodetails-imagegallery" href="assets/images/products/product-image-6.jpg" data-caption="Product Zoom Image 6">
                            ...
                            <div class="tab-content" id="prodetails-content">
                                ...
                                <div class="tab-pane fade" id="prodetails-area2" role="tabpanel" aria-labelledby="prodetails-area2-tab">
                                    <div class="tm-prodetails-review">
                                        ...
                                        <div class="tm-comment-wrapper mb-50">
                                            ...
                                            <div class="tm-comment">
                                                <div class="tm-comment-thumb">
                                                    <img src="{{ asset('images/image-products') }}/{{ $product->image }}" alt="author image">
                                                </div>
                                                <?php

                                                use Illuminate\Support\Facades\DB;

                                                $productDetails = DB::table('comments')->get(); ?>
                                                @foreach($productDetails as $comment )
                                                <div class="tm-comment-content">
                                                    <h6 class="tm-comment-authorname"><a href="#">{{ $comment->username}}</a>
                                                    </h6>
                                        ...
                                        <form action="{{route('addcomments')}}" class="tm-form" method="post">
                                            <div class="tm-form-inner">
                                                ...
                                                <div class="tm-form-field tm-form-fieldhalf">
                                                    <input type="text" placeholder="Your Name*" required="required" name="username">
                                                </div>
                                                <div class="tm-form-field tm-form-fieldhalf">
                                                    <input type="Email" placeholder="Your Email*" required="required" name="email">
                                                </div>
                                                <div class="tm-form-field">
                                                    <textarea name="product-review" cols="30" rows="5" placeholder="Your Review" name="content"></textarea>
                                                </div>
                                                <div class="tm-form-field">
