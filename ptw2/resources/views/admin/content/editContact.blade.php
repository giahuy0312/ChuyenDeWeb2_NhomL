                    ...
                    <div class="card-body">
                        <form action="{{route('editcategory') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" placeholder="Ten category" id="category_name"
                                    value="{{$getDataCategoryById[0]->category_name}}" class="form-control"
                                    name="cate_name" required autofocus>
